...
def ConNet(inputs, keep_prob, n_classes):
    ...
    dropout = tf.nn.dropout(tf.nn.relu(fc), keep_prob, 'relu_dropout')
...
def ConvNetmodel(train_X, train_Y, test_X, test_Y, learning_rate=0.09, num_epochs=100, 
